                        ...
                        <form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/users/create">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" minlength ="3" class="form-control" id="last_name" name="last_name" required placeholder="Nom" >
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" minlength ="3"class="form-control" id="first_name" name="first_name" required placeholder="Prenom" >
                                    </div>
                                </div>
                                <div class="form-group">
